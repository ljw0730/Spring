...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/ljw/style_join02_info_input.css">
		<!--  <link rel="stylesheet" type="text/css" href="css/style_footer.css"> -->
		<script type="text/javascript" src="js/ljw/jquery-3.4.1.min.js"></script>
		<script type="text/javascript" src="js/ljw/prefixfree.dynamic-dom.min.js"></script>
		<script type="text/javascript" src="js/ljw/jquery-ui.min.js"></script>
		<script type="text/javascript" src="js/ljw/script_join02_info_input.js"></script>
	...
	<body>
		<header>
			<div id="nav_up">
				<ul>
					...
					<li><a href="../kwh/login.html">로그인</a></li>
					<li><a href="../kwh/notice_list.html">고객행복센터</a></li>
					<li><a href="#">배송지역검색</a></li>
					<li><a href="../kwh/admin_login.html">admin</a></li>
				</ul>
			</div>	
			<nav>
				<a href="../myg/main.html"></a>
				<ul>
					<li class="main_menu_list"><a href="#">COOKIT소개</a></li>
					<li class="main_menu_list"><a href="#">COOKIT메뉴</a></li>
					<li class="main_menu_list"><a href="#">리뷰</a></li>
					<li class="main_menu_list"><a href="../kwh/event_list.html">이벤트</a></li>
					<li class="main_menu_list"><a href="#">MY쿡킷</a></li>
				</ul>
				<ul>
					<li>
		...
		<section>
			<form id="join" name="join" method="get" action="join03_success">
				...
				<div id="join_step_div">
					<ul>
						...
						<li style="background-color: #fff; color: #000;">
							<span>STEP.2</span>
							<p>회원정보</p>
						</li>
						<li style="background-color: #8b8075; color: #fff;">
							<span>STEP.3</span>
							<p>회원정보확인</p>
						</li>
					</ul>
				...
				<fieldset class="fieldset_class">
					...
					<dl id="join_id_dl">
						...
						<dd>
							<input type="text" id="id" name="id" minlength="4" maxlength="16" value="${memberDTO.id }" required/>
							<input type="button" value="중복확인" id="double_check" onclick="open_id_doubble_check()"/>
					...
					<dl id="join_pw1_dl">
						...
						<dd>
							<input type="password" id="pw1" name="pw1" minlength="8" value="${memberDTO.pw1 }" required />
					...
					<dl id="join_mail_dl">
						...
						<dd>
							<input type="text" id="mail_id" name="mail_id" value="${memberDTO.mail_id }"required />
							<span>@</span>
							<input type="text" id="mail_tail" name="mail_tail" value="${memberDTO.mail_tail }" required />
					...
					<dl id="join_address_dl">
						...
						<dd>
							<input type="text" id="f_postal" name="f_postal" value="${memberDTO.f_postal }" required />
							<span>-</span>
							<input type="text" id="l_postal" name="l_postal" required />
							<input type="button" value="우편번호" id="postal_btn" onclick="open_address_postal()"/>
							<input type="text" id="address1" name="address1" value="${memberDTO.address1 }" required />
							<input type="text" id="address2" name="address2" value="${memberDTO.address2 }" required />
						</dd>
					...
					<dl id="join_tell_dl">
						...
						<dd>
							<input type="text" id="f_tell" name="f_tell" maxlength="3" value="${memberDTO.f_tell }" required />
							<span> - </span>
							<input type="text" id="m_tell" name="m_tell" maxlength="4" value="${memberDTO.m_tell }" required />
							<span> - </span>
							<input type="text" id="l_tell" name="l_tell" maxlength="4" value="${memberDTO.l_tell }" required />
						</dd>
					</dl>
					<dl id="join_birth_dl">
						<dt>
						...
						<dd>
							...
							<span>일</span>
							<div>
								<c:if test="${memberDTO.calendar == 'lunar' }">
								...
								<c:if test="${memberDTO.calendar == 'solar' }">
					...
					<dl id="join_gender_dl">
						...
						<dd>
							<div>
								<c:if test="${memberDTO.gender == 'male' }">
									<input type="radio" name="gender" id="male" value="male" checked="checked"/>
									<label for="male">남성</label>
									<input type="radio" name="gender" id="female" value="female" />
									<label for="female">여성</label>
								</c:if>
								<c:if test="${memberDTO.gender == 'female' }">
					...
					<dl id="join_newsletter_dl">
						...
						<dd>
							...
							<div>
								<c:if test="${memberDTO.newletter == 'yes' }">
								...
								<c:if test="${memberDTO.newletter == 'no' }">
